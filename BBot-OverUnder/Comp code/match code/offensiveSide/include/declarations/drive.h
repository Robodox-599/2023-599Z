...
/*constants nesssasary for calculations, these are not defaulted 
  to any value so they must be set in the main file*/
...
/*swing conditions*/
  ...
  float swing_timeout;
/*Desired heading for turn_to_angle() function,
 it is basically the varibale which holds the 
...
/*Very simple drive function which drives the motors
...
/*allowing for certain parameters only in the turn to angle function, some are required as moving along*/
...
/*allowing for certain parameters only in the drive function, some are required as moving along*/
...
/*allowing for certain parameters only in the swing turn functions, some are required as moving along*/
